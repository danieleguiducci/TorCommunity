...
public class CryptoUtil implements InitializingBean {
    ...
    private int urlLength = 15; //byte length for the domain url
    private BigInteger p = new BigInteger("358021667241052329260477917967335643");
    private BigInteger g=new BigInteger("");
    ...
    public byte[] generatePublicSid(byte[] digestPrivateKey) {
    ...
    public byte[] domainSid2publicDomain(byte[] domainSid, byte msgHash[]) {
        ...
        BigInteger domainSidInt = new BigInteger(domainSid);
